...
public class PurchaseInvoiceId implements Serializable {
  ...
  @JsonCreator
  public static PurchaseInvoiceId from(@NonNull String value) {
    try {
  ...
  public static PurchaseInvoiceId from(@NonNull UUID value) {
    return new PurchaseInvoiceId(value);
  }

  public static PurchaseInvoiceId generate() {
