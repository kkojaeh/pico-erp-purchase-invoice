...
public class PurchaseInvoiceItemId implements Serializable {
  ...
  @JsonCreator
  public static PurchaseInvoiceItemId from(@NonNull String value) {
    try {
  ...
  public static PurchaseInvoiceItemId from(@NonNull UUID value) {
    return new PurchaseInvoiceItemId(value);
  }

  public static PurchaseInvoiceItemId generate() {
