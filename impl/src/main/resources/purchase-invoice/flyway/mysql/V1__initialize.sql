create table prp_purchase_invoice (
...
create table prp_purchase_invoice_detail (
	id binary(16) not null,
	canceled_date datetime,
...
create table prp_purchase_invoice_detail_dependency (
...
create index IDX4u38vicd6x51xqmoya88xyexh
	on prp_purchase_invoice_detail (plan_id);

alter table prp_purchase_invoice_detail_dependency
	add constraint FKm1ku03g9i8gw2te2vw2t6kp3h foreign key (plan_detail_id)
	references prp_purchase_invoice_detail (id);
